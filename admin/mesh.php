    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item despe">
                            ...
                            <ul class="submenu nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="mesh.php">
                                        <i class="fas fa-boxes"></i>
                                        MESH
                                    </a>
                                </li>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="info-mesh p-3 mt-3">
                    <div class="row">
                        <div class="col-6">
                            <h3>Inventario - MESH</h3>
                        </div>
                ...
                <div class="table-responsive tabla-mesh p-3 mt-3">
                    <table class="table table-sm text-center" id="tabla-mesh">
