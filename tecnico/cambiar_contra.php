                    ...
                    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                        ...
                        <div class="contenedor-title mb-4 mt-4 p-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="col-6">
                                        <input class="form-control" type="password" id="contraseña" placeholder="Ingrese su nueva contraseña">
                                    </div><br>
                                </div>
                                <div class="col-12">
                                    <div class="col-6">
                                        <input class="form-control" type="password" id="contraseña_re" placeholder="Ingrese denuevo su contraseñá">
                                    </div>
                                </div>
                                <div class="col-6 mt-3 mr-10">
                                    <input class="btn btn-success btn-block btn-cambiar_con" type="submit" value="Cambiar Contraseña">
                                </div>
                            </div>
                        </div>
